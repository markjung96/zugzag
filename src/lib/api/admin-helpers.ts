 ...
 * 검토 대기 루트 삭제
 */
export async function deletePendingRoute(id: string) {
  const supabase = await createClient();
 ...
 * 검토 대기 루트 승인
 */
export async function approvePendingRoute(id: string) {
  const supabase = await createClient();
 ...
 * 검토 대기 루트 거부
 */
export async function rejectPendingRoute(id: string, reason?: string) {
  const supabase = await createClient();
 ...
 * 색깔 매핑 목록 조회
 */
export async function getColorMappings(gymId?: string) {
  const supabase = await createClient();
 ...
 * 색깔 매핑 생성
 */
export async function createColorMapping(data: {
  gym_id: string;
  color: string;
 ...
 * 색깔 매핑 삭제
 */
export async function deleteColorMapping(id: string) {
  const supabase = await createClient();
