  ...
  public: {
    Tables: {
      ...
      crew_invite_uses: {
        ...
        Relationships: [
          {
            foreignKeyName: "crew_invite_uses_invite_id_fkey"
            columns: ["invite_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "crew_invite_uses_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      crew_members: {
        Row: {
          ...
          role: Database["public"]["Enums"]["crew_member_role"]
          user_id: string
        }
        Insert: {
          crew_id: string
      ...
      schedule_attendances: {
        ...
        Relationships: [
          {
            foreignKeyName: "schedule_attendances_phase_id_fkey"
            columns: ["phase_id"]
            isOneToOne: false
          ...
          },
          {
            ...
            columns: ["schedule_id"]
            isOneToOne: false
            referencedRelation: "schedule_stats"
      ...
      schedule_phases: {
        ...
        Relationships: [
          {
            foreignKeyName: "schedule_phases_gym_id_fkey"
            columns: ["gym_id"]
            isOneToOne: false
            referencedRelation: "gym_route_stats"
            referencedColumns: ["gym_id"]
