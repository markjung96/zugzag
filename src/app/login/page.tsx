          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="mx-auto mb-4 h-1 w-24 rounded-full bg-gradient-to-r from-orange-500 to-cyan-400"
              />
              <p className="text-zinc-400">ZUGZAG에 오신 것을 환영합니다</p>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center text-zinc-400">
                  <input
                    type="checkbox"
                    className="mr-2 h-4 w-4 rounded border-zinc-700 bg-zinc-900 text-orange-500 focus:ring-2 focus:ring-orange-500/20"
                  />
                  로그인 상태 유지
                </label>
                <button
              ...
              <motion.button
                type="submit"
                disabled={isLoading}
                className="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-4 font-semibold text-white shadow-lg disabled:cursor-not-allowed disabled:opacity-50"
            ...
            >
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="bg-zinc-950 px-4 text-zinc-500">또는</span>
                </div>
              </div>
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <motion.button
                  ...
                  disabled={isLoading}
                  className="flex items-center justify-center rounded-xl border border-zinc-800 bg-zinc-900/50 px-4 py-3 font-medium text-white backdrop-blur-sm transition-all hover:bg-zinc-800/50 disabled:cursor-not-allowed disabled:opacity-50"
            ...
            >
              아직 크루원이 아니신가요?{" "}
              <button className="font-semibold text-cyan-400 transition-colors hover:text-cyan-300">
                가입하기
              </button>
            </motion.p>
          </motion.div>
