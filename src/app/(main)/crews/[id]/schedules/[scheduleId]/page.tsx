...
export default function ScheduleDetailPage() {
  ...
  const rsvpMutation = useMutation({
    ...
    onMutate: async (roundId) => {
      ...
      const previousData = queryClient.getQueryData<ScheduleDetail>(["schedule", scheduleId])
      ...
      if (previousData) {
        ...
        queryClient.setQueryData<ScheduleDetail>(["schedule", scheduleId], {
          ...previousData,
